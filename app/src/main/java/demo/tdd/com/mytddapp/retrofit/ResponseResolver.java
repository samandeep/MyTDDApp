...
import demo.tdd.com.mytddapp.util.Util;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

import static demo.tdd.com.mytddapp.constant.AppConstant.SESSION_EXPIRED;
import static demo.tdd.com.mytddapp.retrofit.ErrorUtils.DEFAULT_STATUS_CODE;
...
//
    ...
    public ResponseResolver(final Context mContext, final Boolean showLoading) {
        ...
        if (showLoading) {
            ProgressDialog.show(mContext, mContext.getString(R.string.loading), "");
        }
    }
    ...
    private String resolveNetworkError(final Throwable cause) {
        Log.e("resolveNetworkError", RESOLVE_NETWORK_ERROR + "  ==  " + String.valueOf(cause.toString()));
